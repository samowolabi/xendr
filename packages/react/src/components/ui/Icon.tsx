...
const registry: Record<IconName, React.ReactNode> = {
  ...
  // MingCute Icon (Apache-2.0, MingCute Design)
  'cloud-download': (
    <path
      fill="currentColor"
